...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Cloth")
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="BST-collections")
    ...
    contact = models.CharField(max_length=100, default="(+254)769 634 770")
...
class Product(models.Model):
    ...
    title = models.CharField(max_length=100, default="Best design")
